      ...
      >
        ...
        <div className="text-[10px] sm:text-xs text-gray-400 hidden xs:block">Music categories</div>
          ...
          <section id="playlists" className="space-y-3 sm:space-y-4">
            ...
            {/* Playlists Section */}
            {loadingPlaylists ? (
              <div className="grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-[repeat(auto-fit,minmax(120px,1fr))] md:grid-cols-[repeat(auto-fit,minmax(140px,1fr))] lg:grid-cols-[repeat(auto-fit,minmax(160px,1fr))] gap-2 sm:gap-3 md:gap-4">
              ...
              <div className={`grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-[repeat(auto-fit,minmax(120px,1fr))] md:grid-cols-[repeat(auto-fit,minmax(140px,1fr))] lg:grid-cols-[repeat(auto-fit,minmax(160px,1fr))] gap-2 sm:gap-3 md:gap-4 transition-all duration-300 ease-in-out ${isAnimatingPlaylists ? 'opacity-75 transform scale-95' : 'opacity-100 transform scale-100'}`}>
          ...
          <section id="recently" className="space-y-4">
            ...
            {loadingRecently ? (
              ...
              <ErrorMessage message={errors.recently} />
                ...
                <div className={`grid grid-cols-2 xs:grid-cols-3 sm:grid-cols-[repeat(auto-fit,minmax(120px,1fr))] md:grid-cols-[repeat(auto-fit,minmax(140px,1fr))] lg:grid-cols-[repeat(auto-fit,minmax(160px,1fr))] gap-2 sm:gap-3 md:gap-4 transition-all duration-300 ease-in-out ${isAnimatingRecently ? 'opacity-75 transform scale-95' : 'opacity-100 transform scale-100'}`}>
